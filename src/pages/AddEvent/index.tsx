        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center">
            ...
            <Section styles="flex-col">
                <div className="flex flex-row">
                    <IOContext label="Título  do Evento">
                        <Input
                            name="title"
                    ...
                    <IOContext label="CPF ou CNPJ" marginLeft="ml-[37px]">
                        <Input
                            name="responsible"
            ...
            <Section styles="flex-col">
                <IOContext label="Detalhes sobre o seu evento!">
                    <TextArea
                        name="descripton"
            ...
            <Section styles="flex-row">
                <IOContext label="Início do Evento">
                    <div className="flex flex-row">
                        <Date
                            name="startDate"
                ...
                <IOContext label="Fim do Evento" marginLeft="ml-[103px]">
                    <div className="flex flex-row">
                        <Date
                            name="endDate"
            ...
            <Section title="Endereço" subtitle="Preencha o endereço do evento" styles="flex-col">
                ...
                <div className="flex flex-row">
                    ...
                    <IOContext label="Cidade" marginLeft="ml-[37px]">
                        <Input
                            name="city"
                    ...
                    <IOContext label="Estado" marginLeft="ml-[37px]">
                        <Select
                            name="uf"
                            data={UF}
                            value={formValues.uf}
            ...
            >
                <div className="flex flex-row mb-[34px]">
                    <IOContext label="Nome do Ingresso">
                        <Input
                            name="nameTicket"
                    ...
                    <IOContext label="Tipo" marginLeft="ml-[25px]">
                        <Select
                            name="typeTicket"
                            data={TYPES_TICKETS}
                    ...
                    <IOContext label="Preço" marginLeft="ml-[25px]">
                        <Money
                            name="priceTicket"
